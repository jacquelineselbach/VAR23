declare module "lib/cannon-es-master/src/utils/EventTarget" {
...
declare module "lib/cannon-es-master/src/math/Quaternion" {
...
declare module "lib/cannon-es-master/src/math/Mat3" {
    import { Vec3 } from "math/Vec3";
...
declare module "lib/cannon-es-master/src/math/Vec3" {
...
declare module "lib/cannon-es-master/src/math/Transform" {
    import { Vec3 } from "math/Vec3";
...
declare module "lib/cannon-es-master/src/material/Material" {
...
declare module "lib/cannon-es-master/src/shapes/Shape" {
...
declare module "lib/cannon-es-master/src/collision/RaycastResult" {
    import { Vec3 } from "math/Vec3";
    import type { Body } from "objects/Body";
...
declare module "lib/cannon-es-master/src/shapes/Sphere" {
...
declare module "lib/cannon-es-master/src/shapes/ConvexPolyhedron" {
    import { Shape } from "shapes/Shape";
    import { Vec3 } from "math/Vec3";
    import type { Quaternion } from "math/Quaternion";
...
declare module "lib/cannon-es-master/src/shapes/Box" {
    import { Shape } from "shapes/Shape";
    import { Vec3 } from "math/Vec3";
...
declare module "lib/cannon-es-master/src/shapes/Plane" {
    import { Shape } from "shapes/Shape";
    import { Vec3 } from "math/Vec3";
    import type { Quaternion } from "math/Quaternion";
...
declare module "lib/cannon-es-master/src/utils/Utils" {
    export class Utils {
        static defaults(options: Record<string, any> | undefined, defaults: Record<string, any>): Record<string, any>;
    }
}
declare module "lib/cannon-es-master/src/shapes/Heightfield" {
    import { Shape } from "shapes/Shape";
    import { ConvexPolyhedron } from "shapes/ConvexPolyhedron";
    import { Vec3 } from "math/Vec3";
...
declare module "lib/cannon-es-master/src/utils/Octree" {
...
declare module "lib/cannon-es-master/src/shapes/Trimesh" {
    import { Shape } from "shapes/Shape";
    import { Vec3 } from "math/Vec3";
    import { AABB } from "collision/AABB";
...
declare module "lib/cannon-es-master/src/math/JacobianElement" {
    import { Vec3 } from "math/Vec3";
...
declare module "lib/cannon-es-master/src/equations/Equation" {
...
declare module "lib/cannon-es-master/src/solver/Solver" {
...
declare module "lib/cannon-es-master/src/solver/GSSolver" {
...
declare module "lib/cannon-es-master/src/collision/Broadphase" {
...
declare module "lib/cannon-es-master/src/collision/NaiveBroadphase" {
...
declare module "lib/cannon-es-master/src/utils/Pool" {
    export class Pool {
        objects: any[];
        type: any;
...
declare module "lib/cannon-es-master/src/utils/Vec3Pool" {
...
declare module "lib/cannon-es-master/src/equations/ContactEquation" {
...
declare module "lib/cannon-es-master/src/equations/FrictionEquation" {
    import { Equation } from "equations/Equation";
    import { Vec3 } from "math/Vec3";
    import type { Body } from "objects/Body";
...
declare module "lib/cannon-es-master/src/shapes/Particle" {
    import { Shape } from "shapes/Shape";
    import { Vec3 } from "math/Vec3";
    import type { Quaternion } from "math/Quaternion";
...
declare module "lib/cannon-es-master/src/shapes/Cylinder" {
    import { ConvexPolyhedron } from "shapes/ConvexPolyhedron";
...
declare module "lib/cannon-es-master/src/material/ContactMaterial" {
    import type { Material } from "material/Material";
...
declare module "lib/cannon-es-master/src/world/Narrowphase" {
    import { Shape } from "shapes/Shape";
    import { Vec3 } from "math/Vec3";
    import { Quaternion } from "math/Quaternion";
    import { Body } from "objects/Body";
...
declare module "lib/cannon-es-master/src/collision/ArrayCollisionMatrix" {
    import type { Body } from "objects/Body";
...
declare module "lib/cannon-es-master/src/collision/OverlapKeeper" {
...
declare module "lib/cannon-es-master/src/utils/TupleDictionary" {
...
declare module "lib/cannon-es-master/src/constraints/Constraint" {
    import type { Body } from "objects/Body";
    import type { Equation } from "equations/Equation";
...
declare module "lib/cannon-es-master/src/world/World" {
...
declare module "lib/cannon-es-master/src/collision/Ray" {
    import { Vec3 } from "math/Vec3";
    import { Quaternion } from "math/Quaternion";
    import { RaycastResult } from "collision/RaycastResult";
    import { Shape } from "shapes/Shape";
...
declare module "lib/cannon-es-master/src/collision/AABB" {
    import { Vec3 } from "math/Vec3";
    import type { Ray } from "collision/Ray";
    import type { Transform } from "math/Transform";
    import type { Quaternion } from "math/Quaternion";
...
declare module "lib/cannon-es-master/src/objects/Body" {
    import { EventTarget } from "utils/EventTarget";
    import { Vec3 } from "math/Vec3";
    import { Mat3 } from "math/Mat3";
    import { Quaternion } from "math/Quaternion";
...
declare module "lib/cannon-es-master/src/collision/ObjectCollisionMatrix" {
    import type { Body } from "objects/Body";
...
declare module "lib/cannon-es-master/src/collision/GridBroadphase" {
    import { Broadphase } from "collision/Broadphase";
    import { Vec3 } from "math/Vec3";
    import type { Body } from "objects/Body";
    import type { World } from "world/World";
...
declare module "lib/cannon-es-master/src/collision/SAPBroadphase" {
    import { Broadphase } from "collision/Broadphase";
    import type { AABB } from "collision/AABB";
    import type { Body } from "objects/Body";
    import type { World } from "world/World";
...
declare module "lib/cannon-es-master/src/constraints/PointToPointConstraint" {
...
declare module "lib/cannon-es-master/src/equations/ConeEquation" {
    import { Vec3 } from "math/Vec3";
    import { Equation } from "equations/Equation";
    import type { Body } from "objects/Body";
...
declare module "lib/cannon-es-master/src/equations/RotationalEquation" {
    import { Equation } from "equations/Equation";
    import { Vec3 } from "math/Vec3";
    import type { Body } from "objects/Body";
...
declare module "lib/cannon-es-master/src/constraints/ConeTwistConstraint" {
...
declare module "lib/cannon-es-master/src/constraints/DistanceConstraint" {
    import { Constraint } from "constraints/Constraint";
    import { ContactEquation } from "equations/ContactEquation";
    import type { Body } from "objects/Body";
...
declare module "lib/cannon-es-master/src/equations/RotationalMotorEquation" {
    import { Equation } from "equations/Equation";
    import { Vec3 } from "math/Vec3";
    import type { Body } from "objects/Body";
...
declare module "lib/cannon-es-master/src/constraints/LockConstraint" {
    import { PointToPointConstraint } from "constraints/PointToPointConstraint";
    import { RotationalEquation } from "equations/RotationalEquation";
    import { Vec3 } from "math/Vec3";
    import type { Body } from "objects/Body";
...
declare module "lib/cannon-es-master/src/constraints/HingeConstraint" {
    import { PointToPointConstraint } from "constraints/PointToPointConstraint";
    import { RotationalEquation } from "equations/RotationalEquation";
...
declare module "lib/cannon-es-master/src/objects/Spring" {
    import { Vec3 } from "math/Vec3";
    import type { Body } from "objects/Body";
...
declare module "lib/cannon-es-master/src/objects/WheelInfo" {
    import { Vec3 } from "math/Vec3";
...
declare module "lib/cannon-es-master/src/objects/RaycastVehicle" {
    import type { Body } from "objects/Body";
...
declare module "lib/cannon-es-master/src/objects/RigidVehicle" {
    import { Vec3 } from "math/Vec3";
    import { Body } from "objects/Body";
...
declare module "lib/cannon-es-master/src/objects/SPHSystem" {
    import { Vec3 } from "math/Vec3";
    import type { Body } from "objects/Body";
...
declare module "lib/cannon-es-master/src/solver/SplitSolver" {
    import { Solver } from "solver/Solver";
    import { Body } from "objects/Body";
    import type { Equation } from "equations/Equation";
    import type { World } from "world/World";
...
declare module "lib/cannon-es-master/src/cannon-es" {
